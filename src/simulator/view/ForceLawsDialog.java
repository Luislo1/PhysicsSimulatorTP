...
public class ForceLawsDialog extends JDialog implements SimulatorObserver {
	...
	private void setNewForceLaws() { // Create a JSONObject with the new force law values and pass them to the
										// controller
	...
	private void fillInTable(int index) { // Fill table with the "data" section of the forceLawsInfo
		JSONObject info = _forceLawsInfo.get(index); // (a) obtaining the i-th element of _forceLawsInfo
		JSONObject data = info.getJSONObject("data"); // (b) obtaining the value of key “data” of info
