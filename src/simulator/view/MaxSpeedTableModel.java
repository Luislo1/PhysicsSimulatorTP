...
public class MaxSpeedTableModel extends AbstractTableModel implements SimulatorObserver{
	...
	private void removeFirst() { // Para hacer que siempre haya N simulation steps cuerpos o menos en la tabla y nunca más.
		_bodies.remove(0);
		_time.remove(0);
	...
	@Override
	public void onAdvance(Map<String, BodiesGroup> groups, double time) { // En cada step busco el body con mayor velocidad de todos y esa velodidad la guardo.
		Double maxSpeed = 0.0;
		Body maxBody = null;
	...
	@Override
	public void onRegister(Map<String, BodiesGroup> groups, double time, double dt) { // Pq en el onRegister y los de abajo solo pongo fireTableStructureChanged?
		fireTableStructureChanged();
	}
