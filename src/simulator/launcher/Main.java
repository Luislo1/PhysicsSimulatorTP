...
public class Main {
	...
	private static void initFactories() { // create an instance of each builder, and an ArrayList for each kind of
											// builder (forceLaws & bodies) then a new factory with the corresponding
											// list
